          ...
          return (
            ...
            >
              <CardContent className="p-6 text-center space-y-3">
                <div
                  className={`w-14 h-14 rounded-full mx-auto flex items-center justify-center bg-card border ${accentClass}`}
                >
                  <Icon
                    className={`w-7 h-7 ${detail.accent === 'primary' ? 'text-primary' : detail.accent === 'accent' ? 'text-accent' : 'text-secondary'}`}
                  />
                </div>
                <div>
