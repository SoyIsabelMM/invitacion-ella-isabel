...
export function HeroSection() {
  return (
    <section className="relative min-h-[90vh] flex flex-col items-center justify-center px-4 py-16">
      ...
      <div className="absolute inset-0 bg-gradient-to-b from-secondary/40 via-background/90 to-background" />
      
      {/* Decorative elements */}
      <div className="absolute top-20 left-10 animate-float">
        <Star className="w-8 h-8 text-primary fill-primary/30" />
      </div>
      <div className="absolute top-32 right-12 animate-float" style={{ animationDelay: "0.5s" }}>
      ...
      <div className="relative z-10 text-center space-y-8">
        ...
        <div className="relative space-y-2">
          ...
          <div className="relative inline-block my-6">
            <span className="text-[10rem] md:text-[14rem] lg:text-[18rem] font-black gradient-gold bg-clip-text text-transparent leading-none drop-shadow-2xl" style={{ WebkitBackgroundClip: "text" }}>
              6
            </span>
            ...
            <div className="absolute -bottom-2 -left-4 animate-twinkle" style={{ animationDelay: "0.3s" }}>
        ...
        <div className="mt-8 glassmorphism rounded-lg p-4 border-glow max-w-md mx-auto">
          <div className="flex items-center justify-between border-b border-primary/30 pb-3 mb-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs text-muted-foreground uppercase tracking-wider">VIP Pass</span>
            </div>
        ...
        <div className="pt-8 animate-bounce">
          ...
          <p className="text-xs text-muted-foreground mt-2">Desliza para ver más</p>
        </div>
      </div>
    </section>
  )
