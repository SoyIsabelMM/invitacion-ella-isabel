...
export function SpecialNotes() {
  return (
    <section className="space-y-4">
      ...
      <Card className="border-2 border-accent/50 bg-accent/10 overflow-hidden glow-pink">
        <CardContent className="p-5">
          <div className="flex items-start gap-4">
            <div className="w-12 h-12 rounded-full shrink-0 flex items-center justify-center bg-accent/20 border-2 border-accent/50">
      ...
      <Card className="border-2 border-primary/60 bg-linear-to-r from-primary/20 via-accent/10 to-secondary/20 overflow-hidden glow-gold animate-pulse-glow">
